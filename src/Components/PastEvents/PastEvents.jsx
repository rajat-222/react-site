        ...
        <div className="events-wrapper">
          ...
          <div className="gallery-container">
            <div className="gallery">
              <div className="frame">
                <img className="image" src={require("./Assets/1.jpeg")} />
                <br />
                <div className="info">Java Paathsala</div>
              </div>
              <div className="frame">
                <img className="image" src={require("./Assets/2.png")} />
                <br />
              ...
              <div className="frame">
                <img className="image" src={require("./Assets/5.png")} />
                <br />
                <div className="info">Buggymania 2.0</div>
              </div>
              <div className="frame">
                <img className="image" src={require("./Assets/6.png")} />
                <br />
                <div className="info">Infosec Talk</div>
              </div>
              <div className="frame">
                <img className="image" src={require("./Assets/7.png")} />
                <br />
                <div className="info">C++ Paathshala</div>
              </div>
              <div className="frame">
                <img className="image" src={require("./Assets/8.jpg")} />
                <br />
                <div className="info">Cloud Computing</div>
              </div>
            </div>
          </div>
          <button className="events-button">see more</button>
        </div>
      </div>
    </>
  );
